...
class DeformableDETR(DetectionTransformer):
    ...
    def pre_transformer(
        ...
        for lvl, (feat, mask, pos_embed) in enumerate(
            ...
            print('Structure-Adaptive Perturbation')    # The source code is currently incomplete and will be fully released once the manuscript is accepted by the journal.
